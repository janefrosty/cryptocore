...
Конфиденциальность: Шифрование на основе AES-CTR
Целостность: Аутентификация GHASH
Аутентификация: 16-байтовый тег аутентификации
Связанные данные: Поддержка аутентифицированных незашифрованных данных
Обнаружение несанкционированного доступа: Обнаруживает изменения зашифрованного текста, AAD и ключа
